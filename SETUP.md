...
**If you are the person:** open your LLM tool (Claude Code, Cursor, or similar) in this folder and say "set up wikiOS." The model reads this file and asks you what it needs. Budget an hour for the conversation and a few days of ordinary use before wikiOS feels like yours.
